...
INSERT INTO `permission`(permission_id, name, description, url, perms, parent_id, type, order_num, icon, status) VALUES ('20104', '删除', '删除用户', '/user/delete', 'user:delete', '201', '2', '0', '', '1');
INSERT INTO `permission`(permission_id, name, description, url, perms, parent_id, type, order_num, icon, status) VALUES ('20105', '批量删除', '批量删除用户', '/user/batch/delete', 'user:batchDelete', '201', '2', '0', '', '1');
INSERT INTO `permission`(permission_id, name, description, url, perms, parent_id, type, order_num, icon, status) VALUES ('20106', '分配角色', '分配角色', '/user/assign/role', 'user:assignRole', '201', '2', '0', '', '1');
...
INSERT INTO `permission`(permission_id, name, description, url, perms, parent_id, type, order_num, icon, status) VALUES ('20201', '列表查询', '角色列表查询', '/role/list', 'role:list', '202', '2', '0', '', '1');
INSERT INTO `permission`(permission_id, name, description, url, perms, parent_id, type, order_num, icon, status) VALUES ('20202', '新增', '新增角色', '/role/add', 'role:add', '202', '2', '0', '', '1');
INSERT INTO `permission`(permission_id, name, description, url, perms, parent_id, type, order_num, icon, status) VALUES ('20203', '编辑', '编辑角色', '/role/edit', 'role:edit', '202', '2', '0', '', '1');
...
INSERT INTO `permission`(permission_id, name, description, url, perms, parent_id, type, order_num, icon, status) VALUES ('20304', '删除', '删除资源', '/permission/delete', 'permission:delete', '203', '2', '0', '', '1');
